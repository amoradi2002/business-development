...
const DOLLAR_FIELDS = new Set(["currentLoanBalance", "propertyValue"]);
...
export default function RefinanceAnalysisPage() {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    } else if (name === "currentInterestRate") {
        ...
        <div className="overflow-hidden rounded-xl bg-white shadow-lg">
          <div className="bg-[#3d9b3d] px-6 py-8 text-center sm:px-10">
            ...
            <p className="mt-2 text-sm text-green-50 sm:text-base">
              See how much you could save with a better rate
            </p>
          </div>
          ...
          <div className="px-6 py-8 sm:px-10">
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  {submitting ? "Submitting..." : "Get My Refinance Analysis"}
                </button>
