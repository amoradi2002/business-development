...
export default function PreQualificationPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const payload = {
      ...
      desiredAmount: form.desiredLoanAmount,
        ...
        <div className="overflow-hidden rounded-xl bg-white shadow-lg">
          <div className="bg-[#3d9b3d] px-6 py-8 text-center sm:px-10">
            ...
            <p className="mt-2 text-sm text-green-50 sm:text-base">
              Know exactly what you can borrow before you shop
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <input
                    ...
                    value={
                      form.estimatedPropertyValue
                        ? formatDollars(form.estimatedPropertyValue)
                        : ""
                    }
                    onChange={handleChange}
                    placeholder="$0"
                  ...
                  <input
                    ...
                    value={
                      form.desiredLoanAmount
                        ? formatDollars(form.desiredLoanAmount)
                        : ""
                    }
                    onChange={handleChange}
                    placeholder="$0"
                ...
                <div>
                  ...
                  <input
                    ...
                    name="monthlyIncome"
                    value={
                      form.monthlyIncome ? formatDollars(form.monthlyIncome) : ""
                    }
                    onChange={handleChange}
                    placeholder="$0"
                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 shadow-sm focus:border-[#3d9b3d] focus:outline-none focus:ring-1 focus:ring-[#3d9b3d]"
